...
# Generation date: 2026-09-01T12:49:47
# Schema: bookstore
#
...
slots.email = Slot(uri=BOOKSTORE.email, name="email", curie=BOOKSTORE.curie('email'),
                   model_uri=BOOKSTORE.email, domain=None, range=Optional[str])
